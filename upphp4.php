...
//updating Php certificate information of members
	...
	$sub2 = $_POST['Sub2'];
		...
		if (!empty($mcq))
		{
		$query2 = "UPDATE php SET MCQ='$mcq' WHERE Name = '$name'";
		$result = mysqli_query($dbc, $query2);
		}
		
		if (!empty($sub1))
		{
		$query3 = "UPDATE php SET Subjective1='$sub1' WHERE Name = '$name'";
		$result = mysqli_query($dbc, $query3);
		}
		
		if (!empty($sub2))
		{
		$query4 = "UPDATE php SET Subjective2='$sub2' WHERE Name = '$name'";
		$result = mysqli_query($dbc, $query4);
		}
		
		if (!empty($username))
		{
			$query = "UPDATE php SET Name='$username' WHERE Name = '$name'";
