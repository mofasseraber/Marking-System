<?php
//registering PHP certificate for members
	session_start();
	$_SESSION ['message'] ='';
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST')
	{
			...
			$sql = "INSERT INTO php (Name, MCQ, Subjective1, Subjective2)
...
<body>
	...
	<h2> Register PHP Certificate </h2>
	
	<form method="post" id="form" action="regphp.php">
		<p>
