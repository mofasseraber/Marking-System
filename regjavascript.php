<?php
//registering Javascript certificatefor members
	session_start();
	$_SESSION ['message'] ='';
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST')
	{
			...
			$sql = "INSERT INTO javascript (Name, MCQ, Subjective1, Subjective2)
...
<head>
	<title> Register JAVASCRIPT Certificate</title>
...
<body>
	...
	<h2> Register Javascript Certificate </h2>
	
	<form method="post" id="form" action="regjavascript.php">
		<p>
